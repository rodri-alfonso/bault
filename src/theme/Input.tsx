...
export default function Input({
  ...
  const TrailerIcon = () => {
    ...
    if (trailerIcon)
      return (
        <button onClick={trailerEvent} className='p-1.5 rounded-xl text-gray-600 active:scale-95 transition-all'>
          {trailerIcon}
        </button>
      )
  }
  ...
  return (
    <div
      className={`py-2 px-4 rounded-xl flex items-center gap-1.5 text-gray-600 ${trailerIcon ? 'pr-3' : ''}`}
